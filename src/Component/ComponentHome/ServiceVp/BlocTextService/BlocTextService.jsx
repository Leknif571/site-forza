  ...
  const textService = [
    {
     ...
     title:'Véhicule',
     description : 
     "Retrouvez notre catalogue de véhicules dans la rubrique catalogue ou en cliquant sur le bouton ci-dessous",
     content : ''
    },
    {
     id:1,
     ...
     <div> 
      ...
      <p className='pt-4-'>1- Consultation : Contactez-nous pour discuter de vos préférences, vos besoins et votre budget. Notre équipe d'experts en automobile est là pour vous conseiller.</p>
      ...
      <p className='pt-4'>4- Accompagnement : Une fois que vous avez sélectionné votre véhicule idéal, notre équipe s'occupe de chaque étape du processus, de l'inspection initiale jusqu'à l'achat. </p>
    </div>
    },
    { 
     id:2,
    ...
    },
    {
     ...
     content: <div>
      ...
      <p className='pt-4'>Fiscalité : Vous conseiller sur les implications fiscales liées à la possession et à l'utilisation de votre voiture, telles que les taxes de circulation, les taxes d'importation (le cas échéant) et d'autres frais gouvernementaux associés.</p>
    ...
    },
    {
      ...
      title:'Livraison',
      description : 
      "Afin de garantir un confort optimal, Forza propose la livraison de votre véhicule selon vos préférences. Notre service de livraison vous contacte systématiquement pour confirmer le créneau horaire convenu pour la livraison de votre véhicule.",
      content: <div>
                <p className='pt-4'> 
                  Cette livraison est réalisée par un chauffeur de notre équipe, offrant une démonstration complète du véhicule ainsi qu'une explication détaillée de son fonctionnement et de ses options. 
                </p>
                <p className='pt-4'>
                  C’est l’opportunité de poser toutes vos questions, auxquelles il répondra avec plaisir. La livraison à domicile est une expérience  avec un service complémentaire réalisée par Forza.
                </p>
                <p className='pt-4'>
                   Son prix est calculé en fonction de la distance entre notre agence où se trouve votre véhicule et le lieu de livraison, garantissant ainsi une expérience sereine. 
                </p>
                <p className='pt-4'>
