  ...
  return (
    <div className='h-full'>
        <div className='hidden lg:block lg:w-full lg:pl-16 lg:pt-8'>
            <Breadcrumbs key='danger' color='danger' size='lg'>
                ...
                <BreadcrumbItem>A propos</BreadcrumbItem>
            </Breadcrumbs>
        </div>
    ...
    <div className='px-10 py-4'>
        <div className='flex flex-col p-4 lg:flex-row justify-between'>
            <h1 className='flex justify-center text-3xl font-titlef text-left lg:pt-8 lg:text-4xl lg:pl-4'>A propos</h1>
        ...
        <div className='text-gray-400 text-lg md:text-xl p-2 text-left'>
            <p>Voici les a propos de notre site.</p>
        </div>
